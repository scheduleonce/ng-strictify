...
- [ONCEHUB-116980](https://scheduleonce.atlassian.net/browse/ONCEHUB-116980) fixed vulnerability found in package vite

## [2.0.9] - 2025-10-27

### fixed CVE-2025-66035 vulnerability found in package @angular/common in project ng-strictify

- In project test-app [JIRA](https://scheduleonce.atlassian.net/browse/ONCEHUB-108087)
